...
export default function CameraScreen() {
    ...
    useEffect(() => {
        (async () => {
            ...
            console.log(cameraStatus, audioStatus, galleryStatus)

            if (galleryStatus.status == 'granted') {
                const userGalleyMedia = await MediaLibrary.getAssetsAsync({ sortBy: ['creationTime'], mediaType: ['video'] })
                setGalleryItems(userGalleyMedia.assets)
            }
        })();
        ...
        <View style={styles.container}>
            ...
            <View style={styles.bottomBarContainer}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    {galleryItems[0] == undefined ? <Feather name='zap' size={24} color={'white'}/> :
                        <Image
                            styles={styles.galleryButtonImage}
                            source={{ uri: `${galleryItems[0].uri}/${galleryItems[0].id}` }}
                        />
